      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-14">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md space-y-10">    
            ...
            <div class="space-y-6 bg-white p-6 rounded-xl shadow-lg">
              <h2 class="text-2xl font-semibold border-b pb-2 mb-4">訂購人資料</h2>
              <!-- 姓名 -->
              <div class="space-y-4">
                ...
                <Field
                  ...
                  rules="required"
                  placeholder="請輸入姓名"
                  class="w-full border border-gray-300 rounded-lg p-3 bg-gray-50 focus:border-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300"
              ...
              <!-- 地址 -->
              <div v-if="['cod', 'credit', 'linepay'].includes(paymentStore.selectedMethod?.value)" class="flex flex-wrap space-y-4">
                ...
                <div class="grid grid-cols-3 gap-2 w-full">
                  ...
                  <Field
                    name="buyer_county"
                    as="select"
                    class="border border-gray-300 rounded-lg p-3 focus:border-blue-500 focus:ring-2 focus:ring-blue-300"
                  ...
                  <ErrorMessage name="buyer_county" class="text-red-500 text-xs mt-1 col-span-3" />
                  ...
                  <ErrorMessage name="buyer_district" class="text-red-500 text-xs mt-1 col-span-3" />

                  <!-- 郵遞區號（readonly） -->
                  <input
                    type="text"
                    class="border border-gray-300 rounded-lg p-3 bg-gray-50 focus:border-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300"
                    placeholder="郵遞區號"
                  ...
                  <Field
                    name="buyer_address"
                    type="text"
                    class="border border-gray-300 rounded-lg p-3 bg-gray-50 focus:border-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300 col-span-3"
                    placeholder="請輸入街道地址"
                    v-model="paymentStore.orderInfo.user_info.address"
                    rules="required|min:5"
                  />
                  <ErrorMessage name="buyer_address" class="text-red-500 text-xs mt-1 col-span-3" />
                </div>
              </div>
              ...
              <div class="space-y-4">
                ...
                <ErrorMessage name="tel" class="text-red-500 text-xs mt-1" />
              </div>
            </div>
            <!-- 收件人資料 -->
            <div class="space-y-3 bg-white p-6 rounede-xl shadow-lg">
              <!-- 收件件人資料 貨到付款 信用卡線上付款 LINE Pay(可用 LINE Points 折抵)-->
              <div v-if="['cod','credit','linepay'].includes(paymentStore.selectedMethod?.value)" class="flex flex-wrap items-center gap-2 border-b pb-2 mb-4">
              ...
              <div class="space-y-4">
                ...
                />
                <ErrorMessage name="shipping_name" class="text-red-500 text-xs mt-1" />
              </div>
              <!-- 7-11 全家 -->
              <div v-if="['7-11', 'familymart'].includes(paymentStore.selectedMethod?.value)"> 
                <span>取貨門市</span>
              ...
              <div v-if="['cod', 'credit', 'linepay'].includes(paymentStore.selectedMethod?.value)" class="flex flex-wrap space-y-4">
                ...
                <div class="grid grid-cols-3 gap-2 w-full">
                  ...
                  <ErrorMessage name="shipping_county" class="text-red-500 text-xs mt-1 col-span-3" />
                  ...
                  <ErrorMessage name="shipping_district" class="text-red-500 text-xs mt-1 col-span-3" />
                  ...
                  <Field
                    ...
                    rules="required|min:5"
                  />
                  <ErrorMessage name="shipping_address" class="text-red-500 text-xs mt-1 col-span-3" />
                </div>
              </div>
              <!-- Email -->
              <div class="space-y-4">
                ...
                />
                <ErrorMessage name="shipping_email" class="text-red-500 text-xs mt-1" />
              </div>
              <!-- 收件人電話 -->
              <div class="space-y-4">
                ...
                />
                <ErrorMessage name="shipping_tel" class="text-red-500 text-xs mt-1" />
              </div>
              <!-- 備註 -->
              <div class="space-y-4">
                ...
                <Field
                  ...
                  rows="4"
                  placeholder="請輸入備註"
                  class="w-full border border-gray-300 rounded-lg p-3 bg-gray-50 focus:border-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-300 resize-none"
            ...
            <!-- 發票資訊 -->
            <div class="space-y-3 bg-white p-6 rounede-xl shadow-lg">
              <h2 class="text-lg font-semibold border-b pb-2 mb-4">發票資訊</h2>
              <!-- 選擇發票類型 -->
              <div class="flex flex-col sm:flex-row sm:flex-wrap w-full gap-3">
                <button
                 ...
                 :class="[
                   'px-4 py-2 rounded-lg border font-medium transition-all duration-200 shadow-sm hover:shadow-md active:scale-95',
                   paymentStore.orderInfo.invoice_info.type === type 
              ...
              <div v-if="paymentStore.orderInfo.invoice_info.type === '手機條碼'">
                ...
                />
                <ErrorMessage name="mobile_barcode" class="text-red-500 text-xs mt-1" />
              </div>
              <!-- 統一編號 -->
              <div v-if="paymentStore.orderInfo.invoice_info.type === '統一編號'">
                ...
                />
                <ErrorMessage name="tax_id" class="text-red-500 text-xs mt-1" />
              </div>
